...
# def plot_dataframe_columns(data, save_dir=None):
#     """
#     Plots each column of the dataframe as a separate figure.

#     :param df: The pandas DataFrame to plot.
#     :param save_dir: Directory to save the plots. If None, plots are only displayed.
#     """

#     columns = ['Cd', 'Cl', 'p_probe_0', 'p_probe_1', 'p_probe_2', 'p_probe_3', 'p_probe_4', 'p_probe_5', 'p_probe_6', 'p_probe_7', 'p_probe_8', 'p_probe_9', 'p_probe_10', 'p_probe_11']
...
#         if save_dir:
#             plt.savefig(f"{save_dir}/{column}_plot.png")
